...
elixir.setup {
  ...
  elixirls = {
    ...
    on_attach = function(client, bufnr)
      -- vim.keymap.set("n", "<Leader>lEfp", ":ElixirFromPipe<cr>", { buffer = true, noremap = true })
      -- vim.keymap.set("n", "<Leader>lEtp", ":ElixirToPipe<cr>", { buffer = true, noremap = true })
      -- vim.keymap.set("v", "<Leader>lEem", ":ElixirExpandMacro<cr>", { buffer = true, noremap = true })
    end
  }
}
