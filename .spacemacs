...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (elixir :variables
             elixir-backend 'lsp
             elixir-ls-path "/home/blacksheep/.elsp"
...
before packages are loaded."
  (setq x86-lookup-pdf "/home/blacksheep/Dropbox/asm/manuals/intel/325383-sdm-vol-2abcd.pdf")
  (setq org-bullets-bullet-list '("■" "◆" "▲" "▶"))
  (setq projectile-project-search-path '("~/wok/" "~/wip/"))
  (define-key evil-normal-state-map (kbd "C-c")
    (lambda() (interactive) (treemacs-find-file) (treemacs-select-window)))
  (define-key evil-normal-state-map (kbd "<f2>") 'treemacs-select-window)
  (define-key evil-normal-state-map (kbd "<f3>") 'ibuffer)
  (define-key evil-normal-state-map (kbd "<f4>") 'spacemacs-layouts/non-restricted-buffer-list-helm)
  (define-key evil-normal-state-map (kbd "<f5>") 'lazy-helm/helm-recentf)
  (define-key evil-normal-state-map (kbd "<f6>") 'lazy-helm/spacemacs/helm-find-files)

  ;; non funziona
  (define-key evil-normal-state-map (kbd "<f10>") 'spacemacs/helm-project-smart-do-search)
  )
